...
Below is the external dependencies table with their id and description as examplified in [OWASP Threat Modeling Process](https://owasp.org/www-community/Threat_Modeling_Process), the ids in bold are the ones identified by AI (Claude):
